...
export default function Hero() {
  return (
    <div className="flex flex-col gap-[1rem] lg:flex-row lg:justify-between lg:items-center">
      <div className="flex flex-col gap-[1rem] lg:w-[50%]">
        ...
        <div className="flex flex-col gap-[1rem] lg:flex-row">
          <button className="w-[100%] bg-primary px-[1.25rem] py-[1rem] text-white font-bold transition-all hover:bg-primary-hover">
            Mulai belajar
          </button>
          <button className="w-[100%] bg-none px-[1.25rem] py-[1rem] text-white font-bold border-2 border-white transition-all hover:bg-white hover:text-black">
            Lihat contoh materi
          </button>
        </div>
      </div>
